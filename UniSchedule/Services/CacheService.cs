...
public class CacheService
{
    ...
    {
        foreach (var key in _cache.Keys.Where(k => k.StartsWith("static:")).ToList()) _cache.TryRemove(key, out _);
    }
    ...
    {
        foreach (var key in _cache.Keys.Where(k => k.StartsWith("schedule:")).ToList()) _cache.TryRemove(key, out _);
    }
}