...
public class Localization
{
    ...
    public Localization(IConfiguration configuration, Debug dbg)
    {
        ...
        var lang = configuration.GetValue<string>("Language") ?? throw new KeyNotFoundException();
        var path = Path.Combine(Directory.GetCurrentDirectory(), "UniSchedule/Local", lang + ".json");
