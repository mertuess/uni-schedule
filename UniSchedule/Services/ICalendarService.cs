...
public class CalendarService : ICalendarService
{
    ...
    private (TimeSpan start, TimeSpan end) ParseSlotTime(string slot)
    {
        var slotMap = new Dictionary<string, (TimeSpan, TimeSpan)>
        {
            ...
            ["2"] = (TimeSpan.FromHours(10).Add(TimeSpan.FromMinutes(40)),
                TimeSpan.FromHours(12).Add(TimeSpan.FromMinutes(10))),
            ["3"] = (TimeSpan.FromHours(12).Add(TimeSpan.FromMinutes(20)),
                TimeSpan.FromHours(13).Add(TimeSpan.FromMinutes(50))),
            ["4"] = (TimeSpan.FromHours(14), TimeSpan.FromHours(15).Add(TimeSpan.FromMinutes(30))),
            ["5"] = (TimeSpan.FromHours(15).Add(TimeSpan.FromMinutes(40)),
                TimeSpan.FromHours(17).Add(TimeSpan.FromMinutes(10))),
            ["6"] = (TimeSpan.FromHours(17).Add(TimeSpan.FromMinutes(20)),
                TimeSpan.FromHours(18).Add(TimeSpan.FromMinutes(50)))
        };
